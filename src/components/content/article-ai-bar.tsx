...
const AI_PROVIDERS: AIProvider[] = [
  {
    ...
    icon: <ChatGPTIcon />,
    getUrl: (url) =>
      `https://chat.openai.com/?q=${encodeURIComponent(`Read this article: ${url}`)}`,
  },
  {
    id: "claude",
    label: "Claude",
    icon: <ClaudeIcon />,
    getUrl: (url) =>
      `https://claude.ai/new?q=${encodeURIComponent(`Read this article: ${url}`)}`,
  },
  {
    id: "grok",
    label: "Grok",
    icon: <GrokIcon />,
    getUrl: (url) => `https://grok.com/?q=${encodeURIComponent(`Read ${url}`)}`,
  },
];
