...
export const KOKORO_VOICES = [
  ...
  { id: "af_nicole", label: "Nicole — polished female" },
  { id: "af_sarah", label: "Sarah — clear female" },
  { id: "af_sky", label: "Sky — airy female" },
  { id: "af_alloy", label: "Alloy — soft female" },
  { id: "af_aoede", label: "Aoede — light female" },
  { id: "af_jessica", label: "Jessica — conversational female" },
  { id: "af_kore", label: "Kore — balanced female" },
  { id: "af_nova", label: "Nova — youthful female" },
  { id: "af_river", label: "River — gentle female" },
  { id: "am_michael", label: "Michael — calm male" },
  { id: "am_adam", label: "Adam — deep male" },
  { id: "am_fenrir", label: "Fenrir — textured male" },
  { id: "am_puck", label: "Puck — energetic male" },
  { id: "am_echo", label: "Echo — light male" },
  { id: "am_eric", label: "Eric — conversational male" },
  { id: "am_liam", label: "Liam — relaxed male" },
  { id: "am_onyx", label: "Onyx — dark male" },
  { id: "am_santa", label: "Santa — character male" },
